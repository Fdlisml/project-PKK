...
if (isset($_POST['add_product'])) {
   ...
   if (mysqli_num_rows($select_product_name) > 0) {
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `product`(name, category, price, image) VALUES('$name', '$category', '$price', '$image')") or die('query failed');
...
if (isset($_POST['update_product'])) {
   ...
   mysqli_query($conn, "UPDATE `product` SET name = '$update_name', category = '$update_category', price = '$update_price' WHERE id = '$update_p_id'") or die('query failed');
      ...
      <div class="box-container">
         ...
         ?>
               <div class="box">
                  ...
                  <div class="jenis"><?php echo $fetch_products['category']; ?></div>
